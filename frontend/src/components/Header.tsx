          ...
          <div className="flex items-center gap-3 md:gap-5">
            ...
            <div className="relative">
              <button
                ...
                className="flex h-10 w-10 items-center justify-center overflow-hidden rounded-full border-2 border-[#6ba2a6] font-bold transition focus:ring-2 focus:ring-[#1e3e44]"
                title={user.name}
                aria-label="Abrir menu de perfil"
              >
                <AvatarFallback name={user.name} src={user.avatar} className="h-full w-full object-cover rounded-full" />
              </button>
